...
> The Overview section features the product information, description and images. The user can see the description and features of the product underneath the images and the product details on the right.
